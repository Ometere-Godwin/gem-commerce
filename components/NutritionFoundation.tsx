    ...
    <div className="bg-[#F8F8F8] min-h-screen md:min-h-[80vh]">
      <Container className="">
        <div className="flex flex-col md:flex-row gap-10 py-8 md:py-16">
          <div className="flex flex-col flex-1 gap-y-8 md:gap-y-5">
            ...
            <div className="flex flex-col gap-3 md:gap-3">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-2">
                <span className="text-xl md:text-2xl font-bold">97%</span>
                <div>
                  <p className="text-sm md:text-base">
            ...
            <button className="bg-[#EE6F4B] text-white px-6 md:px-10 py-3 rounded-[6px] w-full md:w-auto text-sm md:text-base">
